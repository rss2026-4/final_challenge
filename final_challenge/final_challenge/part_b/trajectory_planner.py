...
from geometry_msgs.msg import Point, PoseArray, PoseStamped, PoseWithCovarianceStamped, PointStamped
...
class PathPlan(Node):
    ...
    def __init__(self):
        ...
        self.clicked_sub = self.create_subscription(PointStamped, "/clicked_point", self.clicked_point_cb, 10)
    ...
    def clicked_point_cb(self, msg):
        # takes in clicked point and adds to list of waypoints
        point = (msg.point.x, msg.point.y)
        self.goal_locations.append(point)
        self.get_logger().info(f"added point at {point}")


    def state_cb(self, msg):
        if msg.current_state == State.PATH_PLANNING_FORWARD:
            ...
            if self.car_pose is None:
                ...
                return
            goal = self.goal_locations[self.plans_made]
